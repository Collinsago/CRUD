		...
		<?php
        	...
        	while($row = mysqli_fetch_array($run_data))
        	{
				...
				<td class='text-center'>
					<span>
					<a href='#' class='btn btn-success mr-3 profile' data-toggle='modal' data-target='#view$id' 
				...
				<td class='text-center'>
					...
					<a href='#' class='btn btn-warning mr-3 edituser' data-toggle='modal' data-target='#edit$id' 
